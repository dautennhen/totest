...
<div>
    <form action="{{ route('roles.list') }}" method="post" class="form-inline myformsearch">
        <a data-route="{{ route('roles.create') }}" data-form="#item-form" >@lang('common.New item')</a> |
        <br />
