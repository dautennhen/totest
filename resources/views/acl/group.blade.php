...
<div>
    <form action="{{ route('groups.list') }}" method="post" class="form-inline myformsearch">
        <a data-route="{{ route('groups.create') }}" data-form="#item-form" >@lang('common.New item')</a> |
        <br />
